...
function StoreAcceptDecline() {
  ...
  const onClickAccept = async () => {
    var a = web3.utils.numberToHex(Number(1000000000000000));
    try {
        ...
        params: [
          {
            from: account,
            to: test_c_address,
            data: contract.methods.storeAccept_Decline(1, true).encodeABI(),
            gas: "300000",
            value: a,
          },
        ],
        ...
        params: [
          {
            from: account,
            to: c_address,
            data: contract.methods.storeAccept_Decline(1, false).encodeABI(),
          },
        ],
      });
    } catch (error) {
